...
<div class="contact-page">
  <div class="contact-grid">
    ...
    <section class="contact-info-panel" aria-label="About engagements">
      ...
      <h1 class="contact-info-title">Partner with QTransition Labs</h1>
      ...
      <div class="contact-bullets">
        <div class="contact-bullet">
          <div class="contact-bullet-icon">✓</div>
      ...
      <div class="contact-meta-strip">
        ...
        <span class="contact-meta-pill">
          <span class="contact-meta-dot"></span>
