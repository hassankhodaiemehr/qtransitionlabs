...
<section class="demo-page">
  <header class="demo-header">
    ...
    <div class="demo-links">
      ...
      <a href="{{ '/assets/demo/index.html?v=20260703' | relative_url }}" class="button button-ghost" target="_blank" rel="noopener">Open full screen</a>
    </div>
  </header>
  ...
  <div class="demo-frame-wrap">
    <iframe
      ...
      src="{{ '/assets/demo/index.html?v=20260703' | relative_url }}"
